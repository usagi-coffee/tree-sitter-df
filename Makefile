LANGUAGE_NAME := tree-sitter-df
HOMEPAGE_URL := https://github.com/usagi-coffee/tree-sitter-df
VERSION := 0.0.5
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/df '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/df
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/df
